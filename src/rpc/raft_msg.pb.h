...
inline void raft_entry_data_t::_internal_set_obj_name(const std::string& value) {
  ...
  obj_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void raft_entry_data_t::set_obj_name(const char* value) {
  ...
  obj_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:raft_entry_data_t.obj_name)
}
inline void raft_entry_data_t::set_obj_name(const char* value,
    size_t size) {
  
  obj_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
...
inline std::string* raft_entry_data_t::_internal_mutable_obj_name() {
  ...
  return obj_name_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
