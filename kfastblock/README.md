...
- `tool/kfastblock-rawctl pipeline-get-leader --addr <osd_raw_addr:port> --pool-id <id> --pg-id <id> --count 8`
- `tool/kfastblock-rawctl pipeline-read-object --addr <osd_raw_addr:port> --pool-id <id> --pg-id <id> --object <name> --length 4096 --count 8`
- `tool/kfastblock-rawctl pipeline-write-object --addr <osd_raw_addr:port> --pool-id <id> --pg-id <id> --object <name> --data hello --count 8`
- `tool/kfastblock-rawctl pipeline-delete-object --addr <osd_raw_addr:port> --pool-id <id> --pg-id <id> --object <name> --count 8`
