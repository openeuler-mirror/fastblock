...
创建设备controller
```
fastblock/build/deps_build/spdk-prefix/src/spdk/scripts/rpc.py -s /var/tmp/bdev_vhost_192944.sock vhost_create_blk_controller --cpumask 0x100 /var/tmp/vhost.1 fbdev
```
