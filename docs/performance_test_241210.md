...
```
fastblock-bdevperf -b -N bdev_perf.json -m '[80,81,82,83,84,85,86,87]' -C -E -T fbdev -t 240 -o 4096 -q 32 -M 0 -w randwrite
```
...
```
fastblock-bdevperf -b -N bdev_perf.json -m '[80,81,82,83,84,85,86,87,88,89,90,91]' -C -E -T fbdev -t 240 -o 4096 -q 32 -M 0 -w randwrite
```
结果  
网卡监控信息：
...
```
fastblock-bdevperf -b -N bdev_perf.json -m '[80,81,82,83,84,85,86,87]' -C -E -T fbdev -t 240 -o 4096 -q 64 -M 0 -w randwrite
```
