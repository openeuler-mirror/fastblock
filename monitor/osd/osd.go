...
func ProcessBootMessage(ctx context.Context, client *etcdapi.EtcdClient, id int32, uuid string, size int64, sharded_ports map[uint32]uint32, host string, address string) ERRNUM {
