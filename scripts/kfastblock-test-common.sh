...
kfastblock_print_rdma_counters() {
    ...
    for p in rdma_connect_ok rdma_connect_err rdma_connect_timeout rdma_exchange_ok \
             ...
             rdma_pool_hit rdma_pool_miss rdma_io_timeout_total \
             ...
             rdma_pool_evict rdma_pool_aged_out rdma_pool_reclaim \
             rdma_pool_put_fail rdma_pool_destroy_busy \
             rdma_wc_unknown_id rdma_poll_empty_total \
             rdma_conn_error_transitions \
             rdma_inline_threshold rdma_cached_aged_out rdma_cached_lru_evict \
